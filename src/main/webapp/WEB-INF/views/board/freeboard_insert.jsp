        ...
        <div class="con_middle">
            ...
            <div class="content">
            	<div style="height: 610px">
	                <table style="width: 900px; margin: auto;">
	                	...
	                	<form action="board_insert" method="post">
	                		<tr height="50px">
	                			<th colspan="2" style="font-size: 25px; text-align: center; color: #333333">자유게시판 글쓰기</th>
	                		</tr>
							...
							<input id="category" type="hidden" name="category" value="자유 게시판"/>
						</form>
	                </table>
                </div>
                <table style="width: 900px;">
                	<tr>
						<td colspan="2" align="right">
							<input type="button" value="돌아가기" onclick="location.href='board_list?currentPage=${currentPage}&category=자유 게시판'"/>
						</td>
					</tr>
                </table>
			</div>
