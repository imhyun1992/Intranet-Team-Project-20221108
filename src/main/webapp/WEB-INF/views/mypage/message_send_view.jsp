        ...
        <div class="con_middle">
            <div class="nav">
                <ul>
                    ...
                    <li><a href="message_send_view">보낸 쪽지함</a></li>
                </ul>
            </div>
            <!-- =================================contents================================================= -->
                ...
                <div style="height: 80%">
					<table style="width: 900px; margin: auto;"> 
 						<c:if test="${view.size() == 0 }">
							<tr><td colspan="6" align="center">보낸 쪽지가 없습니다.</td></tr>
						</c:if>
						<c:if test="${view.size() != 0 }">
									...
									<tr>
										<td>
											<div style="margin-top:5px; display:flex;">
												<a href='message_content_list?idx=${meo.idx}&currentPage=${MessageList.currentPage}&divs=send'>${meo.title}</a>
												<c:if test="${meo.read == 'NO'}">
													<p style="margin-right:20px;margin-left:auto;  text-align:right; color:#92A9BD;" >읽지않음</p>
												</c:if>
												<c:if test="${meo.read != 'NO'}">
													<p style="margin-right:20px;margin-left:auto;  text-align:right; color:#92A9BD;" >읽음</p>
												</c:if>
											</div>
											<p style="padding-bottom:5px;border-bottom:1px solid black;font-size:8px;">
												...
												<span class="underText">수신 : ${meo.receiveempno} |</span>
